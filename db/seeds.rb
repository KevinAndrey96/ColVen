...
User.create(email: 'transfer@colvenintercambios.com', commission:0.05, zone:'Pruebas', role: 'Transfer', name: 'Transferencias', creator: 'admin@colvenintercambios.com', password: 'Pruebas2018@', password_confirmation: 'Pruebas2018@')